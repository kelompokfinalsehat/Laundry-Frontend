  ...
  components/
    ...
    back-office/
      ...
      outlet/
        ...
        OutletTable.tsx
      penerimaan/
        CreateOrderConfirmationModal.tsx
...
:root {
  ...
  --color-accent-light:#ffc107;    /* background lembut untuk badge/alert info */
...
## File: src/components/back-office/penerimaan/CreateOrderConfirmationModal.tsx
````typescript
"use client";
...
export function WorkerInProgressTask({ stationType, isCompleting, onComplete }: WorkerInProgressTaskProps) {
  ...
  return (
    <Card withBorder radius="lg" p="lg">
      <Stack gap="md">
        ...
        <Button type="button" color="var(--color-accent)" loading={isCompleting} disabled={isCompleting} onClick={onComplete}>
          Tandai Selesai
        </Button>
      </Stack>
    </Card>
...
export function DriverDestinationCard({ title, name, address, phone, latitude, longitude }: DriverDestinationCardProps) {
  ...
  return (
    <Card withBorder radius="lg" p="lg">
      <Stack gap="md">
        ...
        {phone && (
          <Group gap="xs">
            <IconPhone size={16} color="var(--color-text-secondary)" />
