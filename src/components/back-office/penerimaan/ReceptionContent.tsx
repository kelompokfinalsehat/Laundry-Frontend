  ...
  return (
    <>
      <Stack gap="lg">
        ...
        >
          <Tabs.List>
            <Tabs.Tab value="WAITING_RECEIPT">
              Menunggu Diterima
            </Tabs.Tab>

            <Tabs.Tab value="READY_TO_CREATE">
              Siap Dibuatkan Order
            </Tabs.Tab>
          </Tabs.List>
        </Tabs>
